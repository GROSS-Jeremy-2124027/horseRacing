...
/**
 * Classe héritant de la classe abstraite Cheval permettant de créer un cheval étant un Quarter Horse.
 */
public class QuarterHorse extends Cheval {
    /**
     * Constructeur de la classe permettant de créer un nouveau Cheval catégorisé comme étant un Quarter Horse.
