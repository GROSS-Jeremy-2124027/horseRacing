...
/**
 * Classe héritant de la classe abstraite Cheval permettant de créer un cheval état un Mustang
 */
public class Mustang extends Cheval {
    /**
     * Constructeur de la classe permettant de créer un nouveau Cheval catégorisé comme étant un Mustang.
