...
/**
 * Classe héritant de la classe abstraite Cheval permettant de créer un cheval état un Pur sang arabe.
 */
public class PurSangArabe extends Cheval {
    /**
     * Constructeur de la classe permettant de créer un nouveau Cheval catégorisé comme étant un Pur sang arabe.
     ...
     * d'incrémenter l'entier atomic dans le dictionnaire à la clé correspondante au numéro du cheval faisant la couse.
     */
    @Override
    public void run() {
        try {
